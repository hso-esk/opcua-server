    ...
    const e_lwm2m_serverobserver_event_t ev)
{
  ...
  /* TODO: why do we need double ended queue???? 
     WE ONLY WORK with queues here as a priorty buffer, 
     why do we need to access both ends of it for a
     priority buffer????
  */
  std::deque<s_devEvent_t>::iterator it = evQueue.begin();
  // TODO: WTF is this thing doing?
