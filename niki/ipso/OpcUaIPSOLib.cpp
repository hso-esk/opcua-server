 ...
 * OpcUaIPSOLib()
 */
OpcUaIPSOLib::OpcUaIPSOLib(void)
  : OpcUaStackServer::ApplicationIf()
  , ipsofileName_("")
  , namespaceIndex_(0)
  , opcUalwm2mObs(*this)
  , readSensorValueCallback_(boost::bind(&OpcUaIPSOLib::readSensorValue, this, _1))
  , writeSensorValueCallback_(boost::bind(&OpcUaIPSOLib::writeSensorValue, this, _1))
{
  Log(Debug, "OpcUaIPSOLib::OpcUaIPSOLib");
}
 ...
 * startup()
 */
bool OpcUaIPSOLib::startup(void)
{
  Log(Debug, "OpcUaIPSOLib::startup");
 ...
 * shutdown()
 */
bool OpcUaIPSOLib::shutdown()
{
  Log(Debug, "OpcUaIPSOLib::shutdown");
 ...
 * loadConfig()
 */
bool OpcUaIPSOLib::loadConfig(void)
{
  Log(Debug, "OpcUaIPSOLib::loadConfig");
 ...
 * readSensorValue()
 */
void OpcUaIPSOLib::readSensorValue (ApplicationReadContext* applicationReadContext)
{
  Log(Debug, "OpcUaIPSOLib::readSensorValue")
 ...
 * writeSensorValue()
 */
void OpcUaIPSOLib::writeSensorValue (ApplicationWriteContext* applicationWriteContext)
{
  Log(Debug, "OpcUaIPSOLib::writeSensorValue")
 ...
 */
bool OpcUaIPSOLib::registerCallbacks(OpcUaUInt32 id)
{
  Log(Debug, "OpcUaIPSOLib::registerCallbacks");
 ...
 */
bool OpcUaIPSOLib::unregisterCallbacks()
{
  Log(Debug, "OpcUaIPSOLib::unregisterCallbacks");
 ...
 */
bool OpcUaIPSOLib::createObjectDictionary(IPSOParser::ipsoDescriptionVec& ipsoDesc)
{
  Log(Debug, "OpcUaIPSOLib::createObjectDictionary");
 ...
 * createObjectNode()
 */
bool OpcUaIPSOLib::createObjectNode(IPSOParser::ipsoObjectDescription const& objectInfo)
{
  Log(Debug, "OpcUaIPSOLib::createObjectNode");
 ...
 * createVariableNode()
 */
bool OpcUaIPSOLib::createVariableNode(std::vector<IPSOParser::ipsoResourceDescription> const& ipsoresources)
{
  Log(Debug, "OpcUaIPSOLib::createVariableNode");
...
* onDeviceRegister()
*/
int8_t OpcUaIPSOLib::onDeviceRegister(const LWM2MDevice* p_dev)
{
  Log(Debug, "OpcUaIPSOLib::onDeviceRegister");
...
* onDeviceUnregister()
*/
int8_t OpcUaIPSOLib::onDeviceDeregister(const LWM2MDevice* p_dev)
{
  Log(Debug, "OpcUaIPSOLib::onDeviceUnregister");
...
* hasObjectId()
*/
bool OpcUaIPSOLib::hasObjectId(int16_t id, objectDictionary_t dictionary)
{
  Log(Debug, "OpcUaIPSOLib::hasObjectId");
...
*/
bool OpcUaIPSOLib::createLWM2MResources(LWM2MObject* lwm2mObjectInfo
		, std::vector<IPSOParser::ipsoResourceDescription>& ipsoResource)
{
  Log(Debug, "OpcUaIPSOLib::createLWM2MResources");
  ...
  *applicationIf = new OpcUaIPSO::OpcUaIPSOLib();
}
